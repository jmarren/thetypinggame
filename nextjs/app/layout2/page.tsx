    ...
    return (
        <div className='w-full h-full min-h-screen flex flex-row'>
            ...
            <div className='h-full min-h-screen flex-grow flex flex-col justify-center relative'> 
                ...
                {activeModal === ModalType.Leaderboard && <div className='flex-grow w-full min-h-screen flex justify-center items-center z-[100] absolute'><ModalCard ><Leaderboard /></ModalCard> </div>}
